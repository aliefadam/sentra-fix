...
@section('content')
    <div class="relative bg-red-700">
        ...
        <div class="relative max-w-8xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
            <h1 class="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">Selamat Datang di
                Sentrafix</h1>
            <p class="mt-3 text-xl text-white max-w-3xl">Solusi Terpercaya untuk memenuhi kebutuhan anda</p>
        </div>
    </div>
    <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div class="mt-20 flex justify-center">
            <img src="/imgs/maskot.png" class="size-60" alt="">
        </div>
        <div class="mt-20">
            <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3 mx-auto max-w-7xl">
                <div class="bg-white rounded-lg shadow-sm p-8 text-center">
                    <div class="mx-auto flex items-center justify-center h-12 w-12 rounded-md bg-red-700 text-white">
        ...
        <div class="mt-20 bg-white rounded-lg shadow-sm p-8">
            ...
            <div class="grid grid-cols-1 gap-8 sm:grid-cols-3">
                <div class="text-center">
                    <p class="text-4xl font-bold text-red-600">50,000+</p>
                    <p class="mt-2 text-lg text-black">Pelanggan Puas</p>
                </div>
                <div class="text-center">
                    <p class="text-4xl font-bold text-red-600">100,000+</p>
                    <p class="mt-2 text-lg text-black">Transaksi Sukses</p>
                </div>
                <div class="text-center">
                    <p class="text-4xl font-bold text-red-600">4.8/5</p>
        ...
        <div class="mt-20 text-center">
            <a href="{{ route('products') }}"
                class="!rounded-button inline-flex items-center px-8 py-3 border border-transparent text-base font-medium text-white bg-gradient-to-r from-black to-red-500 hover:bg-red-700/90">Belanja
