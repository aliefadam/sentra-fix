    ...
    <main class="max-w-8xl mx-auto px-4 sm:px-4 lg:px-8 py-4 sm:py-8">
        <div class="flex lg:flex-row flex-col lg:gap-0 gap-3 justify-between items-center mb-8">
            ...
            {{-- <div class="flex lg:flex-row flex-col gap-4 w-full lg:w-auto">
                <select id="countries"
                    class="bg-white border border-gray-500 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
                        ...
                        <div class="flex flex-[1] flex-col lg:items-end w-full lg:w-auto lg:mt-0 mt-4">
                            ...
                            <div class="mt-6 flex flex-col items-end gap-3">
                                <button type="button" data-modal-target="default-modal" data-modal-toggle="default-modal"
                                    ...
                                    class="w-fit btn-detail-transaction text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-red-600 dark:hover:bg-red-700 focus:outline-none dark:focus:ring-red-800">
