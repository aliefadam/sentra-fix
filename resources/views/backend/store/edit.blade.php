                ...
                <div class="bg-white p-7 rounded-md shadow-md mb-7 h-fit">
                    ...
                    <div class="mb-5">
                        ...
                        <textarea id="store_description" rows="4" name="store_description"
                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-red-500 focus:border-red-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500 resize-none">{{ $store->description }}</textarea>
                    </div>
                    <div class="mb-2">
                ...
                <div class="">
                    ...
                    <div class="mt-5 flex justify-end">
                        <button type="submit" id="btn-simpan-perubahan"
                            class="text-white bg-gray-500 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 cursor-not-allowed"
                            disabled>
                            Loading...
                        </button>
                    </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $("#btn-simpan-perubahan").removeClass("cursor-not-allowed").addClass(
                        "bg-red-700 hover:bg-red-800").html("Simpan Perubahan").attr("disabled", false);
                }
            });
        }
    </script>
