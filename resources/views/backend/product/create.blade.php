            ...
            <div class=" bg-white shadow-md rounded-md p-5 mb-5">
                    ...
                    <div class="mb-5">
                        ...
                        <select id="category" name="category"
                            ...
                            @foreach ($sub_categories as $sub_category)
                                <option @selected($sub_category->id == $product->sub_category_id) value="{{ $sub_category->id }}">
                                    {{ $sub_category->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="mb-5">
                    ...
                    <textarea id="ckeditor" rows="4" name="description"
                        class="resize-none block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-red-500 focus:border-red-500 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500"
                ...
                <div class="grid grid-cols-2 gap-8 mb-5">
                    <div class="">
                        ...
                        <select id="variant-1" name="variant[]"
                            class="select-2-dropdown bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500">
