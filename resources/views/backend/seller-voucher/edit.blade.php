            ...
            <div class=" bg-white shadow-md rounded-md p-5 mb-5">
                <div class="mb-5">
                    ...
                    <div class="grid grid-cols-2 gap-5">
                        <div class="flex items-center ps-4 border border-gray-200 rounded-sm dark:border-gray-700">
                            <input @checked($voucher->available_for == 'Diskon Total Transaksi') required id="available-for-1" type="radio"
                                value="Diskon Total Transaksi" name="available_for"
                        ...
                        <div class="flex items-center ps-4 border border-gray-200 rounded-sm dark:border-gray-700">
                            <input @checked($voucher->available_for == 'Gratis Ongkos Kirim') required id="available-for-2" type="radio"
                                value="Gratis Ongkos Kirim" name="available_for"
                                class="w-4 h-4 text-pink-600 bg-gray-100 border-gray-300 focus:ring-pink-500 dark:focus:ring-pink-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div id="container-detail">
                    <div class="mb-5">
                        ...
                        <div class="grid grid-cols-2 gap-5">
                            <div class="flex items-center ps-4 border border-gray-200 rounded-sm dark:border-gray-700">
                                <input @checked($voucher->unit == 'Persen') id="unit-1" type="radio" value="Persen"
                                    name="unit"
                                    class="w-4 h-4 text-pink-600 bg-gray-100 border-gray-300 focus:ring-pink-500 dark:focus:ring-pink-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                <label for="unit-1"
                                    class="w-full py-3.5 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                            ...
                            <div class="flex items-center ps-4 border border-gray-200 rounded-sm dark:border-gray-700">
                                <input @checked($voucher->available_for == 'Rupiah') id="unit-2" type="radio" value="Rupiah"
                                    name="unit"
                                    class="w-4 h-4 text-pink-600 bg-gray-100 border-gray-300 focus:ring-pink-500 dark:focus:ring-pink-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                <label for="unit-2"
                                    class="w-full py-3.5 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" id="nominal" name="nominal" value="{{ $voucher->nominal }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-pink-500 focus:border-pink-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-pink-500 dark:focus:border-pink-500" />
                        <span class="text-gray-700 text-xs">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="minimal_transaction" name="minimal_transaction"
                        value="{{ $voucher->minimal_transaction }}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-pink-500 focus:border-pink-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-pink-500 dark:focus:border-pink-500" />
                    <span class="text-gray-700 text-xs">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="maximal_used" name="maximal_used" value="{{ $voucher->maximal_used }}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-pink-500 focus:border-pink-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-pink-500 dark:focus:border-pink-500" />
                    <span class="text-gray-700 text-xs">
                ...
                <div class="flex justify-end">
                    <button type="submit"
                        class="w-full text-white bg-pink-700 hover:bg-pink-800 focus:ring-4 focus:ring-pink-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-pink-600 dark:hover:bg-pink-700 focus:outline-none dark:focus:ring-pink-800">Simpan</button>
                </div>
            </div>
        </div>
    </form>
...
@section('script')
    <script>
        ...
        function initDetail() {
            const value = $("input[name=available_for]:checked").val();
            if (value == "Diskon Total Transaksi") {
                $("#container-detail").show();
                $("input[name=unit]").attr("disabled", false);
                $("input[name=nominal]").attr("disabled", false);
